...
Route::group(['prefix' => 'student', 'middleware' => ['role:Student']], function() {
    ...
    Route::get('/advertisements',[StudentController::class,'advertisementsList']);
...
Route::group(['prefix' => 'teacher', 'middleware' => ['role:Teacher']], function() {
    ...
    Route::get('/get/EducationFileInType/{id}',[CourseController::class,'getCourseNameEducationFileInTypes']);
